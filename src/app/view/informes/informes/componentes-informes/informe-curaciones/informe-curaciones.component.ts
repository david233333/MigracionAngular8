...
import {InformeCuracionesModel} from './informe-curaciones-model';
...
@Component({
  selector: 'sura-informe-curaciones',
  templateUrl: './informe-curaciones.component.html',
  styleUrls: ['./informe-curaciones.component.scss']
})
export class InformeCuracionesComponent implements OnInit, OnDestroy {

  public configEspanolCalendario: any;
  public formulario: FormGroup;
  public informeEgresoModel: InformeCuracionesModel = this.iniciarViewModel();
  ...
  descargarInforme() {
    ...
    this.informeUseCase.consultarInformeCuraciones(ID_CIUDAD, ID_PROGRAMA, fechaInicio.getTime().toString(),
      ...
      const nombreArchivo = `InformeCuraciones${fechaInicio.getTime().toString()}-${fechaFin.getTime().toString()}.csv`;
  ...
  private iniciarViewModel(): InformeCuracionesModel {
    return new InformeCuracionesModel(null, null, null, null, null);
  }
}
